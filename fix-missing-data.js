...
export default async ({ strapi }) => {
  ...
  try {
    ...
    console.log(
      `📊 Current data: ${existingTags.length} tags, ${existingArticles.length} articles, ${existingCategories.length} categories, ${existingAuthors.length} authors`
    );
      ...
      if (categories.length > 0 && authors.length > 0 && tags.length > 0) {
        ...
        await strapi.entityService.create("api::article.article", {
          data: {
            ...
            excerpt:
              "Learn the essential steps and best practices for migrating your business to the cloud successfully.",
            content:
              "<h2>Introduction</h2><p>Cloud migration is a critical step in modernizing your IT infrastructure...</p><h2>Planning Your Migration</h2><p>Before starting your cloud migration journey...</p>",
            status: "published",
            ...
            seoDescription:
              "Learn how to migrate your business to the cloud with our comprehensive guide covering planning, execution, and best practices.",
        ...
        await strapi.entityService.create("api::article.article", {
          data: {
            ...
            content:
              "<h2>Why Cybersecurity Matters</h2><p>Small businesses are increasingly targeted by cybercriminals...</p><h2>Essential Security Measures</h2><p>Implement these key security practices...</p>",
            status: "published",
            publishedAt: new Date(),
            readingTime: 6,
            viewCount: 0,
            ...
            seoDescription:
              "Protect your small business from cyber threats with our comprehensive cybersecurity guide and best practices.",
        ...
        await strapi.entityService.create("api::article.article", {
          data: {
            ...
            content:
              "<h2>Platform Comparison</h2><p>Both AWS and Azure offer comprehensive cloud services...</p><h2>Making Your Choice</h2><p>Consider these factors when choosing...</p>",
            status: "published",
            publishedAt: new Date(),
            readingTime: 10,
            viewCount: 0,
            ...
            seoDescription:
              "Compare AWS and Azure cloud platforms to choose the best solution for your business needs and requirements.",
